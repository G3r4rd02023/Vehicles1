    ...
    public class SeedDb
    {
        ...
        private async Task CheckProceduresAsync()
        {
            if (!_context.Procedures.Any())
            {
                ...
                _context.Procedures.Add(new Procedure { Price = 800, Description = "Frenos delanteros" });
                _context.Procedures.Add(new Procedure { Price = 800, Description = "Frenos traseros" });
                _context.Procedures.Add(new Procedure { Price = 9000, Description = "Líquido frenos delanteros" });
                _context.Procedures.Add(new Procedure { Price = 9000, Description = "Líquido frenos traseros" });
                ...
                _context.Procedures.Add(new Procedure { Price = 8000, Description = "Aceite motor" });
                _context.Procedures.Add(new Procedure { Price = 1000, Description = "Aceite caja" });
                _context.Procedures.Add(new Procedure { Price = 1500, Description = "Filtro de aire" });
                _context.Procedures.Add(new Procedure { Price = 3000, Description = "Sistema eléctrico" });
                _context.Procedures.Add(new Procedure { Price = 1000, Description = "Guayas" });
                _context.Procedures.Add(new Procedure { Price = 600, Description = "Cambio llanta delantera" });
                ...
                _context.Procedures.Add(new Procedure { Price = 3000, Description = "Kit arrastre" });
                _context.Procedures.Add(new Procedure { Price = 3000, Description = "Banda transmisión" });
                _context.Procedures.Add(new Procedure { Price = 700, Description = "Cambio batería" });
                _context.Procedures.Add(new Procedure { Price = 1200, Description = "Lavado sistema de inyección" });
                _context.Procedures.Add(new Procedure { Price = 1200, Description = "Lavada de tanque" });
