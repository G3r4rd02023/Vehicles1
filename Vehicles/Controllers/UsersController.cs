    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create(UserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                User user = await _converterHelper.ToUserAsync(model, path, true);
        ...
        public async Task<IActionResult> Edit(UserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                User user = await _converterHelper.ToUserAsync(model, path, false);
        ...
        public async Task<IActionResult> AddVehicle(VehicleViewModel vehicleViewModel)
        {
            ...
            { 
                path = await _imageHelper.UploadImageAsync(vehicleViewModel.ImageFile);
            }
        ...
        public async Task<IActionResult> AddVehicleImage(VehiclePhotoViewModel model)
        {
            if (ModelState.IsValid)
            {
                string path = await _imageHelper.UploadImageAsync(model.ImageFile);
                Vehicle vehicle = await _context.Vehicles
                    .Include(x => x.VehiclePhotos)
